...
<head>
    <title>Staff - VRA INternational Schools</title>
        ...
        <div class="swiper mySwiper mt-5">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="images/staff-bg.jpg" alt="">
                    <div class="hero-text">
                        <h1 style="font-weight: 600; font-size:60px">Staff</h1>
                        <p>
                            Our dedicated and experienced staff are committed to fostering a positive and inclusive
                            learning
        ...
        <section>
            <div class="row gy-5 staff">
                ...
                <div class="col-md-6 one-">
                    ...
                    <p>
                        VRA Schools boast of fully qualified and professionally trained staff holding various
                        qualications
                        such as university degrees, diplomas and teacher training certificates.</p>
                    <br>
                    <br>
                    <h2>The Non-Teaching Staff
                    </h2>
                    <p>
                        To aid the Teaching Staff to effectively carry out their duties are the non-teaching staff such
                        as
                        Administrators, Administrative Assistants, Accounting Personnel, Library Assistants, Laboratory
                        Assistants, Cleaners, Labourers, Drivers Caterers, Security Staff and a Maintenance Crew.
                    </p>
                </div>
            </div>
        </section>
